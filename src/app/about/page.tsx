...
const techStack: TechItem[] = [
  {
    ...
    description: "Google's advanced multimodal AI models power both the planning and vision components of ALFRED.",
  ...
  },
  {
    ...
    description: "Cross-platform mobile framework for building the ALFRED companion app.",
    ...
    useCase: "Mobile interface that lets users send natural language commands to ALFRED from anywhere.",
  },
  {
    name: "Flask",
...
<section className="py-20 px-6 md:px-8 bg-gradient-to-b from-black via-neutral-950 to-black">
      ...
      <section className="py-20 px-6 md:px-8 bg-black">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-gray-400 text-lg mb-10">
            ALFRED implements a <span className="text-white font-semibold">Two-Model Pipeline</span> architecture that separates task planning from visual execution. This separation allows each model to specialize, improving accuracy and maintainability.
          </p>
      ...
      <section className="py-20 px-6 md:px-8 bg-gradient-to-b from-black via-neutral-950 to-black">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-gray-400 text-center mb-8">Click on any technology to learn more about how it powers ALFRED</p>
