...
const coreFeatures = [
  {
    ...
    description: "Simply tell ALFRED what you want to do in plain English. No scripting, no complex syntax — just natural conversation.",
  ...
  },
  {
    ...
    description: "Chain complex sequences of actions together. ALFRED breaks down tasks into executable steps automatically.",
    glowColor: "blue" as const,
  },
  {
    icon: RefreshCw,
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              {[
                { step: "01", title: "Speak", desc: "Tell ALFRED what you want to accomplish" },
                { step: "02", title: "Plan", desc: "AI breaks down your request into steps" },
                { step: "03", title: "Execute", desc: "Watch as ALFRED completes the task" },
              ].map((item, idx) => (
                <motion.div
                  key={item.step}
      ...
      <section className="py-24 px-6 md:px-8 bg-gradient-to-b from-black to-neutral-950">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              ALFRED goes beyond simple automation. With cutting-edge AI and a modular architecture, 
      ...
      <section className="py-24 px-6 md:px-8 bg-black">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-gray-400 mb-10">
            Download ALFRED today and experience the future of computer automation.
          </p>
