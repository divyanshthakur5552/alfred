...
const features = [
  {
    ...
    description:
      "Simply tell ALFRED what you want to do in plain English. No coding required - just speak naturally like 'Open Chrome and go to YouTube'.",
    link: "#",
  },
  {
  ...
  },
  {
    ...
    description:
      "FastSAM-powered Set-of-Mark technique identifies every UI element on screen. ALFRED sees your screen like you do and clicks the right buttons.",
    link: "#",
  },
  {
    title: "Cross-Application Automation",
    description:
      "Works across any Windows application without pre-configuration. From Notepad to Chrome to specialized software - ALFRED handles them all.",
    link: "#",
  },
  {
