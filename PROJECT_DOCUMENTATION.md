# ALFRED - AI Computer Automation Assistant
...
ALFRED implements a **Two-Model Pipeline** architecture that separates task planning from visual execution:
...
```mermaid
timeline
    title ALFRED Development Roadmap
    ...
    Planned : Voice activation ("Hey ALFRED")
           : Camera/OCR input
